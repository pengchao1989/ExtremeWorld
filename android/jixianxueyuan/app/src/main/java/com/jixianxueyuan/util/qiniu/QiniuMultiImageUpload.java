...
public class QiniuMultiImageUpload {
    ...
    QiniuMultiImageUploadListener listener = null;
    ...
    public void upload(List<String> imagePath, QiniuMultiImageUploadListener listener){
    ...
    private void upLoadImage(){
        ...
        final String fileNamePrefix = "img_";

        uploadManager.put(imagePathList.get(imagePathUploadIndex), fileNamePrefix + Util.getDateKey(), pictureUploadToken.getUptoken(),
