...
public class ServerMethod {
    ...
    static final String test_server_url = "http://app.jixianxueyuan.com:8080/";
    static final String production_server_url = "http://app.jixianxueyuan.com:8080/";
    ...
    public static final String topic_submit_weixin_page(){return method_url_secure + hobby + "topic/submit_weixin_page";}
