...
<div class="container">
	...
	<h6 class=" red-text">为早日实现全国板友大集结，滑板圈决定开始进行一次推广活动</h6>
	<h6 class=" red-text">*成功邀请好友即成为滑板圈永久会员</h6>
	<h6 class=" red-text">*每日抽取一名邀请者送上板面1片</h6>
	<h6 class=" red-text">*凡是成功邀请板店老板加入送上板面1片</h6>
	<h6 class=" red-text">*凡是成功帮我们找到品牌合伙人、媒体合伙人、设计师、赛事顾问的再送上进口整板一块</h6>
	<h6 class=" red-text">活动时间：2016年4月26日起</h6>
	<h6 class=" red-text">活动规则：每天抽奖一次，邀请1人权值+1</h6>
	<br>
