	...
	<div class="container main_content">
		...
		<form id="inputForm" action="${ctx}/${hobby}/video/${action}" method="post" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
				     <p>
	                    <input type="checkbox" class="s1 filled-in form-control" id="hobby_skateboard" name="h" value="skateboard"/>
	                    <label for="hobby_skateboard">滑板</label>
		              </p>
		              <p>
		                  <input type="checkbox"  class="s1 filled-in form-control" id="hobby_parkour" name="h" value="parkour"/>
		                  <label for="hobby_parkour">跑酷</label>
		              </p>
		               <p>
		                  <input type="checkbox"  class="s1 filled-in form-control" id="hobby_bmx" name="h" value="bmx"/>
		                  <label for="hobby_bmx">BMX</label>
		              </p>
				</div>
			</div>
